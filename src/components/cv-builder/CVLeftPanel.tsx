...
import { PublicationsForm } from "@/components/builder/forms/PublicationsForm";
    ...
    <div className="flex w-full flex-col bg-white lg:w-[500px] xl:w-[600px] shrink-0 border-r border-slate-200 z-10 shadow-sm print:hidden">
      <ScrollArea className="h-[calc(100vh-3.5rem)]">
        <div className="p-6 space-y-6">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">Curriculum Vitae Details</h2>
            <p className="text-sm text-slate-500 mt-1">
              Fill in your academic and professional details below.
            </p>
          </div>
          ...
          <Accordion defaultValue={["personal"]} className="w-full">
            ...
            <AccordionItem value="publications" className="border rounded-lg mb-4 px-4 bg-slate-50/50 shadow-sm border-blue-200">
              <AccordionTrigger className="hover:no-underline text-lg font-semibold text-slate-800">
            ...
            <AccordionItem value="languages" className="border rounded-lg mb-4 px-4 bg-slate-50/50 shadow-sm border-blue-200">
              <AccordionTrigger className="hover:no-underline text-lg font-semibold text-slate-800">
                Languages
              </AccordionTrigger>
              <AccordionContent className="pt-2 pb-6">
            ...
            <AccordionItem value="references" className="border rounded-lg mb-4 px-4 bg-slate-50/50 shadow-sm border-blue-200">
              <AccordionTrigger className="hover:no-underline text-lg font-semibold text-slate-800">
                References
              </AccordionTrigger>
              <AccordionContent className="pt-2 pb-6">
