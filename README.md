...
A premium, modern AI-powered resume builder built with Next.js App Router, Tailwind CSS, and Zustand.
...
*Note: For the AI features to work, you will also need to configure a Google Gemini API Key in your `.env.local` file.*
## Getting Started
